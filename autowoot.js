...
function displayUI() {
    ...
    $("#narcis-dialog").append('<div class="vyberPozadie"><img onClick="zmenitPozadie(\'c\')" src="http://i.imgur.com/GnwoIQ0.jpg" width="200" height="100"></div>');
