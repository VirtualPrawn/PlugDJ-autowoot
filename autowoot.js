...
function displayUI() {
    ...
    $("#narcis-dialog").append('<div class="vyberPozadie"><img onClick="zmenitPozadie(\'c\')" src="http://imgur.com/fiYIfDN" width="200" height="100"></div>');
