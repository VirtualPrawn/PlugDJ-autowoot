...
function displayUI() {
    ...
    $("#narcis-dialog").append('<div class="vyberPozadie"><img onClick="zmenitPozadie(\'c\')" src="http://autowoot.itoffice.sk/bin/autowoot-backgrounds/002.jpg" width="200" height="100"></div>');
...
function appendUser(a) {
    var b = a.username,
        e = a.permission,
        c = API.getWaitListPosition(a.id);
    a.admin && (e = 99);
    var d;
    switch (e) {
    case 0:
    ...
    API.getDJ().username == b ? drawUserlistItem("dj", "#fff", b, c) : "normal" === d ? drawUserlistItem("void", colorByVote(a.vote), b, c) : drawUserlistItem(d + imagePrefixByVote(a.vote), colorByVote(a.vote), b, c)
}
